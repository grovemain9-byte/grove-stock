...
| 1-2 | **p2m book新設(¥2M専用)** | 🔵設計待ち | R2: 最強セルcons4×1k-3k(n98,78.6%,月利効率29.7%) | p50mシグナル流用・火曜skip・max2-3で設計→事前登録 | 月利 vs 北極星20% |
...
|---|---|---|---|---|---|
| 3-1 | 五十日・SQアノマリー | 🔵研究済 | 月末月初/5の倍数日の需給バイアス | +0.5-1.5%上乗せ | 極近(日付フィルタ1行) |
